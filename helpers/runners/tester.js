...
RESERVEDIMPORTNAMEARRAY = ["RESERVEDINSPECTEMPTY", "RESERVEDIMPORTNAMEARRAY", "RESERVEDINSPECTSIGNATURE", "RESERVEDINSPECTGETFILE", "RESERVEDINSPECTISMODULE", "RESERVEDINSPECTGETMODULE", "RESERVEDOUTPUTDICTIONARY"]
...
for (name, obj) in [(k, v) for k, v in locals().items()]:
  if name not in RESERVEDIMPORTNAMEARRAY:
    ...
    elif RESERVEDINSPECTISMODULE(obj) and name not in ("sys", "io"):
